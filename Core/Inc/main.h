...
#define MOTOR_IN1_GPIO_Port GPIOD
...
#define LED24V_BLUE_Pin GPIO_PIN_4
#define LED24V_BLUE_GPIO_Port GPIOB
#define LED24V_GREEN_Pin GPIO_PIN_5
#define LED24V_GREEN_GPIO_Port GPIOB
